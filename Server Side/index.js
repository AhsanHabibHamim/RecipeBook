...
const allowedOrigins = [
  ...
  'https://recipe-book-39501.vercel.app'
];
  ...
  try {
    ...
    app.put('/api/recipes/:id', async (req, res) => {
      try {
        ...
        if (!req.body.userId || String(recipe.userId) !== String(req.body.userId)) {
    ...
    app.post('/api/recipes/:id/like', async (req, res) => {
      ...
      try {
        ...
        if (recipe.userId === userId) {
          return res.status(403).json({ message: "You can't like your own recipe" });
        }
